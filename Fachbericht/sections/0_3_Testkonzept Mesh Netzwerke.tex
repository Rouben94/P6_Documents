...
Die verschiedenen Teilnehmer werden mithilfe ihrer MAC-Adresse identifiziert. Jeder verfügt über eine 48-bit lange MAC-Adresse die während der Produktion eingebrannt wurde. Zur Identifizierung werden nur die letzten 32-bit verwendet. Auf dem nRF-52840-Dongle ist diese Adresse auf der Rückseite angegeben (siehe Abbildung ...).
