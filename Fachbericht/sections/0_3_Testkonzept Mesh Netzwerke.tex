...
Msg. Count & Ganze Zahlen & \begin{tabular}[c]{@{}l@{}}Anzahl der Nachrichten die pro Client Node\\versendet werden. \end{tabular} \\
Payload & Small/Large & \begin{tabular}[c]{@{}l@{}}Grosse oder Kleine Payload gemäss Definition\\in Tabelle xy.~\end{tabular} \\
Disturbance & Yes/No & \begin{tabular}[c]{@{}l@{}}Gewollte Störung durch P2P Testinfrastruktur auf\\dem selben Channel. \end{tabular} \\
Msg. Density & - & \begin{tabular}[c]{@{}l@{}}Dichte der Nachrichten. Verhältnis zwischen\\Benchmark Duration und Msg. Count. \end{tabular} \\
\bottomrule
\end{tabular}
