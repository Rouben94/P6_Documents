...
\subsection{Identifizierung der Teilnehmer}\label{subsec:NodeIdentification}
...
\subsection{Konfiguration der Teilnehmer}\label{subsec:NodeConfiguration}
...
\subsection{Starten einer Messung}\label{subsec:NodeConfiguration}
...
\subsection{Einholen der Messdaten}\label{subsec:NodeConfiguration}
