...
\todo[inline]{Wieviele Clients / Server gibt es ? , Wie wurden die Nodes Konfigueriert (Router / Relaying), INwiefern sind diese Eigenschaften verwandt?}

\subsection{Traffic Generation}\label{subsec:TrafficGeneration}

\todo[inline]{Wie wird der Mesh-Traffic generiert (Random / Sequentiell), wie sieht die Verteilung aus bei Sequ? Basis für Message dichte mit FOrmel angeben}
