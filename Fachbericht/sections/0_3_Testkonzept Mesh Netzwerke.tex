...
\todo[inline]{Robin:  Ich würde etwas in dieser Art schreiben: Lichtschalter kommunizieren nur mit Lichtquellen und umgekehrt, sie tauschen jedoch keine Applikationsdaten mit Temperatursensoren aus. }
...
\todo[inline]{Robin:  Der BMN muss nicht der leader sein. Das Protokoll bestimmt den leader automatisch. Es kann auch ein BCN oder ein BSN als leader fungieren.}
...
\begin{enumerate}
	...
	\todo[inline]{Robin:  Werden sie immer noch Grafisch aufbereitet? Diese Funktion brauchen wird doch nicht mehr.}
\end{enumerate}
...
\todo[inline]{Robin:  Bei Thread wird der durchschnitt von allen genommen Hops berechnet.}
