...
Eine Anleitung und der Sourcecode sind im \href{https://github.com/Rouben94/P6_Software}{Github Repository\footnotemark[\value{footnote}]} zu diesem Projekt verfügbar \cite{github_p6_software_p2p_2020}.
...
\footnotetext[\value{footnote}]{\url{https://github.com/Rouben94/P6_Software} \cite{anklin_bobst_horath_rouben94p6_software_nodate}}

\todo[inline]{Link zu Django Website einfügen und Footnote Numbering anpassen.}
...
\todo[inline]{Vorgaben können evtl. noch als Tabelle dargestellt werden. Könnte übersichtlicher sein.}
...
\todo[inline]{Evtl. noch eine kurze Einleitung ins Kapitel Webserver
}
...
\todo[inline]{Bild Parameter Form anpassen. Schreibfehler CSMA-CA}
