...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.8\textwidth]{Webserver_Nodelist.png}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.8\textwidth]{Webserver_nodelist_ausgeklappt.png}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.8\textwidth]{Webserver_Chart.png}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.8\textwidth]{Webserver_Connection.png}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.7\textwidth]{DjangoSoftwaredoku.png}
