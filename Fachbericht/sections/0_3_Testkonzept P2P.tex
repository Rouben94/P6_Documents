...
\todo[inline]{Schreibfehler in der Grafik.->Messurment Parameters}
...
Eine Anleitung und der Sourcecode sind im \href{https://github.com/Rouben94/P6_Software}{Github-Repository\footnote{\url{https://github.com/Rouben94/P6_Software}\cite{anklin_bobst_horath_rouben94p6_software_nodate}}} zu diesem Projekt verfügbar \cite{github_p6_software_p2p_2020}.
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.4\textwidth]{Webserver_Connection.png}
	\caption{Webserver Connection View}
	\label{fig:WebserverConnectionView}
\end{figure}

\subsection{Schritt 3 - Parameter Einstellen}\label{sec:SchrittParameterEinstellen}
...
\begin{table}[h]
	...
	\begin{tabular}{|c|l|c|l|}
		\hline
		\multicolumn{4}{|c|}{\textbf{Start und Stop Channel Feld}}                                                            \\ \hline
		\multicolumn{2}{|c|}{\textbf{IEE 802.15.4 250 kBit}}       & \multicolumn{2}{c|}{\textbf{Alle Anderen Modi}}          \\ \hline
		\multicolumn{2}{|c|}{Start Channel 11 bis Stop Channel 26} & \multicolumn{2}{c|}{Start Channel 0 bis Stop Channel 39} \\ \hline
	\end{tabular}
	\caption{Parameter Start und Stop Channel Feld}
	\label{table:ParameterStartStopChannel}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{|c|l|c|l|}
		\hline
		\multicolumn{4}{|c|}{\textbf{Payload Feld}}                                                            \\ \hline
		\multicolumn{2}{|c|}{\textbf{IEE 802.15.4 250 kBit}} & \multicolumn{2}{c|}{\textbf{Alle Anderen Modi}} \\ \hline
		\multicolumn{2}{|c|}{0 - 120 bit}                    & \multicolumn{2}{c|}{0 - 250 bit}                \\ \hline
	\end{tabular}
	\caption{Parameter Payload Feld}
	\label{table:ParameterPayloadFeld}
\end{table}
...
Die zwei Objekte sind miteinander verknüpft. Wenn ein Node Objekt erstellt wird können die dazugehörigen Channel Informationen ebenso dazu erstellt werden. Dadurch ist eine klare Struktur gegeben. Über das Node Objekt können die verschiedenen Channel Informationen abgerufen werden.
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.4\textwidth]{PortForm.png}
	\caption{Port Form}
	\label{fig:PortForm}
\end{figure}
...
Die erhaltenen Daten werden in der View Node\textunderscore List in einer Dynamischen Tabelle, die jede Sekunde Aktualisiert wird angezeigt. Zudem ist in der View Chart ein Visualisierung der Daten ersichtlich. Die Messergebnisse werden mit Hilfe der Bibliothek \textit{PlotLy} dargestellt. 
