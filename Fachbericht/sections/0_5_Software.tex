...
\hline
\multicolumn{1}{|l|}{Library} & Funktion & Modul & \multicolumn{1}{l|}{Referenz} \\ 
\hline
\multirow{8}{*}{\rotcells{SharedLib}} & Statemachine & bm\_statemachine.c~ & xy \\ 
\cline{2-4}
 & Timesync & bm\_timesync.c & xy \\ 
\cline{2-4}
 & Control & bm\_control.c & xy \\ 
\cline{2-4}
 & Report & bm\_report.c & xy \\ 
\cline{2-4}
 & Logging & bm\_log.c & xy \\ 
\cline{2-4}
 & Flash Save & bm\_flash\_ave.c & xy \\ 
\cline{2-4}
 & CLI & bm\_cli.c & xy \\ 
\cline{2-4}
 & Low Layer Radio & bm\_radio.c & xy \\ 
\hline
\multirow{4}{*}{\rotcells{\begin{tabular}[c]{@{}c@{}}Benchmark\\Management \end{tabular}}} & Flash & Flasher.py & xy \\ 
\cline{2-4}
...
%\begin{tabular}{|c|l|l|c|} 
%\cline{4}
%\multicolumn{1}{l}{} & \multicolumn{2}{l|}{} & \multicolumn{1}{l|}{BT Mesh} \\ 
%\hline
%\multirow{8}{*}{\rotcells{SharedLib}} & Statemachine & bm\_statemachine.c [\ref{subsubsec:Statemachine}]& x \\ 
%\cline{2-4}
% & Timesync & bm\_timesync.c [\ref{subsubsec:Timesync}] & x  \\ 
%\cline{2-4}
% & Control & bm\_control.c [\ref{subsubsec:Control}] & x \\ 
%\cline{2-4}
% & Report & bm\_report.c [\ref{subsubsec:Report}] & x  \\ 
%\cline{2-4}
% & Logging & bm\_log.c [\ref{subsubsec:Logging}]& x  \\ 
%\cline{2-4}
% & Flash Save & bm\_flash\_save.c [\ref{subsubsec:FlashSave}]& x   \\ 
%\cline{2-4}
% & CLI & bm\_cli.c [\ref{subsubsec:CLI}]& x  \\ 
%\cline{2-4}
% & Low Layer Radio & bm\_radio.c [\ref{subsubsec:LowLevelRadio}]& x \\ 
%\hline
%\multirow{4}{*}{\rotcells{\begin{tabular}[c]{@{}c@{}}Benchmark\\Management \end{tabular}}} & Flash & Flasher.py [\ref{subsubsec:Flash}]& x  \\ 
%\cline{2-4}
% & Configurator & Configurator.py [\ref{subsubsec:Configurator}]& x\\ 
%\cline{2-4}
% & Benchmark & \begin{tabular}[c]{@{}l@{}}Benchmark\_and\_\\Reporter.py [\ref{subsubsec:Report}] \end{tabular} & x \\ 
%\cline{2-4}
% & Analysis & Analysis.py [\ref{subsubsec:Analysis}]& x \\
%\hline
%\end{tabular}
%\caption{Übersicht Shared Lib und Benchmark Management Module}
%\label{tab:UebersichtSoftware}
...
Die Zeitsynchronisation wurde identisch wie in Abschnitt \ref{sec:ZeitsynchronisationP2P} umgesetzt. Durch wiederholen der Master-Timestamps, nimmt der Synchronisationsfehler pro Hop zu. Angenommen pro Hop entstehen maximal 1.2us, so wäre der Fehler nach sieben Hops 8.4us. \\ 

Um die Funktionen von Master und Slave zu unterscheiden, wurde eine Subscribe- und Publish-Funktion. 
