...
\begin{itemize}
	...
	\item Bluetooth Mesh hat den grössten Vorteil in einer Umgebung, bei der sich die Knoten stetig bewegen. Dies aus dem Grund, dass das Protokoll keine Routing Knoten verwendet.
...
\begin{itemize}
	...
	\item Die Arbeitsaufteilung hätte besser kommuniziert und besprochen werdenmüssen. ansonsten wird der Arbeitsaufwand für die jeweiligen Personen ungerecht aufgeteilt.
	\todo[inline]{Ich würde das nicht so schreiben.. Auch wenn es stimmt.}
\end{itemize}
...
\begin{itemize}
	...
	\todo[inline]{Stimmt nicht ganz. Zigbee kann die Adresse aus dem Header lesen.} 
\end{itemize}
