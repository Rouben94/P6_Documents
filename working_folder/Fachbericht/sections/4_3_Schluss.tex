...
\begin{table}[H]
	...
	\begin{tabular}{|c|l|c|l|} 
		...
		\hline
		P8                        & \begin{tabular}[c]{@{}l@{}}Einstellbare Frame und \\Kanalwechselrate \end{tabular}                  & Bedingt           & \begin{tabular}[c]{@{}l@{}}Kanalwechselrate kann über das Feld Start \\und Stop Channel eingestellt werden.\end{tabular}                                                                                     \\ 
		\hline
		...
		\hline
		\multicolumn{1}{|l|}{P12} & \begin{tabular}[c]{@{}l@{}}Erfassen der \\Verbindungsqualität \end{tabular}                         & Ja                & \begin{tabular}[c]{@{}l@{}}Der Master sendet und empfängt in einem \\Zeitintervall Frames von den Slave-Nodes \\und sendet die Daten an die \\Serielle-Schnittstelle weiter.\textasciitilde{} \end{tabular}  \\ 
		\hline
