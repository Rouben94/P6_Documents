...
Die Abbildung \ref{fig:KonzeptWebserver} stellt ein erstes Konzept dar, wie der Webserver für die Punkt zu Punkt Verbindung aussehen kann. Die vom BMN ersichtlichen BSN werden aufgelistet und es können verschiedene  Aktionen durchgeführt werden. Mit Reitern soll auf verschiedene Seiten gewechselt werden, bei denen die Resultate oder die Logs der Kommunikation ersichtlich sind.

\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\textwidth]{Web_Mochup_BMS.jpg}
	\caption{Konzept Webserver}\label{fig:KonzeptWebserver}
\end{figure}
